...
import com.myapp.domain.Categorie;
import com.myapp.repository.CategorieRepository;
...
/**
 * REST controller for managing {@link com.myapp.domain.Categorie}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Categorie> partialUpdateCategorie(
        ...
        Optional<Categorie> result = categorieRepository
            ...
            .map(existingCategorie -> {
                ...
                if (categorie.getCreationDate() != null) {
                    existingCategorie.setCreationDate(categorie.getCreationDate());
                }
