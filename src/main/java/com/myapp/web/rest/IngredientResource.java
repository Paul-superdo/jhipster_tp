...
/**
 * REST controller for managing {@link com.myapp.domain.Ingredient}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Ingredient> partialUpdateIngredient(
        ...
        Optional<Ingredient> result = ingredientRepository
            ...
            .map(existingIngredient -> {
                ...
                if (ingredient.getPortions() != null) {
                    existingIngredient.setPortions(ingredient.getPortions());
                }
                if (ingredient.getCreationDate() != null) {
                    existingIngredient.setCreationDate(ingredient.getCreationDate());
                }
